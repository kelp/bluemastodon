...
from social_sync.config import load_config, Config, BlueskyConfig, MastodonConfig
...
class TestConfig:
    ...
    def test_config_dataclass(self):
        ...
        mastodon = MastodonConfig(instance_url="https://example.com", access_token="token")

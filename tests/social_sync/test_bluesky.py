...
from social_sync.models import BlueskyPost, MediaAttachment, Link, MediaType
...
class TestBlueskyClient:
    ...
    def test_get_user_profile_success(self):
        ...
        client.client.app.bsky.actor.getProfile.assert_called_once_with({"actor": "test_user"})
    ...
    def test_get_user_profile_error(self):
        ...
        client.client = MagicMock()
        client.client.app.bsky.actor.getProfile.side_effect = AtProtocolError("API error")
    ...
    def test_fetch_author_feed_error(self):
        ...
        # Create mock client with error
        client.client = MagicMock()
        client.client.app.bsky.feed.getAuthorFeed.side_effect = AtProtocolError("API error")
    ...
    def test_convert_to_bluesky_post(self, mock_extract_links, mock_extract_media):
        ...
        mock_media = [MediaAttachment(url="https://example.com/image.jpg", media_type=MediaType.IMAGE)]
    ...
    def test_extract_media_attachments_with_images(self):
        ...
        with patch.object(client, '_get_blob_url') as mock_get_url:
            mock_get_url.side_effect = lambda p, l: f"https://example.com/{l}"
    ...
    def test_get_recent_posts_success(
        self, mock_convert, mock_should_include, mock_fetch_feed, 
        mock_get_profile, mock_auth
    ):
        ...
        mock_should_include.side_effect = lambda post, since_time: post == mock_feed_view1
    ...
    @patch("social_sync.bluesky.BlueskyClient._get_user_profile")
    @patch("social_sync.bluesky.BlueskyClient._fetch_author_feed")
    def test_get_recent_posts_feed_error(self, mock_fetch_feed, mock_get_profile, mock_auth):

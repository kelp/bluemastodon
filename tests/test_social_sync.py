...
class TestMain:
    ...
    def test_main_success(self, mock_logger, mock_manager_class, mock_load_config, mock_parse_args):
    ...
    @patch('social_sync.SyncManager')
    @patch('social_sync.logger')
    def test_main_with_failures(self, mock_logger, mock_manager_class, mock_load_config, mock_parse_args):
    ...
    @patch('social_sync.SyncManager')
    @patch('social_sync.logger')
    def test_main_dry_run(self, mock_logger, mock_manager_class, mock_load_config, mock_parse_args):
    ...
    @patch('social_sync.SyncManager')
    @patch('social_sync.logger')
    def test_main_dry_run_auth_failure(self, mock_logger, mock_manager_class, mock_load_config, mock_parse_args):

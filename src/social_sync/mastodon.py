...
from social_sync.models import MastodonPost, BlueskyPost, MediaAttachment
...
class MastodonClient:
    ...
    def _format_post_content(self, bluesky_post: BlueskyPost) -> str:
        ...
        content += f"\n\n📱 Originally posted on Bluesky: https://bsky.app/profile/{bluesky_post.author_handle}/post/{bluesky_post.id}"
    ...
    def _convert_to_mastodon_post(self, toot: Any) -> MastodonPost:
            ...
            for media in toot.media_attachments:
                ...
                media_attachments.append(
                    MediaAttachment(
                        ...
                        mime_type=media.mime_type if hasattr(media, 'mime_type') else None,
                    )
                )
        ...
        return MastodonPost(
            ...
            url=toot.url,
            application=toot.application.name if hasattr(toot, 'application') and toot.application else None,
            ...
            favourites_count=toot.favourites_count if hasattr(toot, 'favourites_count') else None,
            reblogs_count=toot.reblogs_count if hasattr(toot, 'reblogs_count') else None,
        )

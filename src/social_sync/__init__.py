...
from social_sync.models import (
    SocialPost, BlueskyPost, MastodonPost, 
    MediaAttachment, Link, MediaType, SyncRecord
)
...
__all__ = [
    "Config", "load_config",
    "BlueskyClient", "MastodonClient", "SyncManager",
    "SocialPost", "BlueskyPost", "MastodonPost",
    "MediaAttachment", "Link", "MediaType",
    "SyncRecord",
    "main",
]
...
def main(args: Optional[List[str]] = None) -> int:
    ...
    try:
        ...
        if parsed_args.dry_run:
            ...
            logger.info(f"Sync completed: {success_count} succeeded, {error_count} failed")
